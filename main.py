...
################################################# span1_span2_distance #################################################
    ...
    plot_span_expected_layer(exp_layer_dict, "threshold", "expected layer", xlim_min=1, xlim_max=MAX_SPR_THRESHOLD_DISTANCE, barGraphToo=False, isSpan=False)
...
################################# EXP LAYER PER SPAN & SPAN DISTRIBUTION ###############################################
    ...
    plot_span_expected_layer(span_exp_layer,"spans", "expected layer", xlim_min=0, xlim_max=3, barGraphToo=True)
    plot_span_expected_layer(span_prob, "spans", "span probability", xlim_min=0, xlim_max=3, barGraphToo=False)
